                            ...
                            if (packetsSent % measurementInterval == 0)
                            {
                                ...
                                if (elapsedSeconds > 0.05) // Need at least 50ms of data
                                {
                                    ...
                                    if (actualMbps > 0 && targetMbps > 0)
                                    {
                                        ...
                                        Logger.Info($"ICMP rate feedback: actual={actualMbps:F2} Mbps, target={targetMbps:F2} Mbps, multiplier={rateMultiplier:F3}, behind={isBehindTarget}, oscillating={isOscillating}");
                                    }
